...
.leBox, .stat-box, .member-container {
    opacity: 0;
    transform: translateY(20px);
}
.admin-footer {
...
.dashboard-wrapper {
    ...
    display: flex;
    flex-direction: column;
    gap: 25px; /* bikin jarak antar box mirip admin */
}
    </style>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="member-welcome leBox">
            <div class="welcome-left">
                <h1 class="welcome-title">Welcome back, <span>Tiara</span> 👋</h1>
